    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateTimeField(default=datetime.datetime(2025, 7, 20, 7, 38, 1, 352632, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateTimeField(default=datetime.datetime(2025, 7, 20, 7, 38, 1, 353637, tzinfo=datetime.timezone.utc))),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='withdrawal_request', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
